...
pyrender.Object.load_obj(pyrender.Object, "./models/Furniture/Furniture.obj")
...
cam = pyrender.Camera(x=-2.6842192755654612, y=3.6094236373901367, z=4.945387839223564, yaw=304.0, pitch=-20.0, roll=0.0, z_near=0.05, z_far=100.0, fov=90, fxaa=False, obj_buffer=True, mode=0)
step = 2
picked_obj = None
do_add_light = False
display_gs = False
